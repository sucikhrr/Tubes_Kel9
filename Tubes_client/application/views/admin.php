        ...
        <div class="row">
          <div class="col-12">
            <div class="header__content">
              <!-- header logo -->
              <a href="<?php echo base_url();?>Admin" class="header__logo">
              ...
              <ul class="header__nav">
                ...
                <li class="header__nav-item">
                  <a href="<?php echo base_url();?>Admin/update"" class="header__nav-link">Update</a>
                </li>
             ...
             <!-- header auth -->
              <div class="header__auth">
                ...
                <a href="<?php echo base_url('login/logout'); ?>" class="header__sign-in">
