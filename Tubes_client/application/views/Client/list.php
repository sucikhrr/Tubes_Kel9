...
<body class="body">
  ...
  <section class="section details">
    ...
    <div class="container">
      <div class="row">
        <!-- title -->
        <div class="col-12">
          <h1 class="details__title">X-Men: Dark Phoenix</h1>
        </div>
        <!-- end title -->
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-5">
                <div class="card__cover">
                  <img src="<?php echo base_url();?>assets/img/covers/xman.jpg" alt="">
                </div>
              </div>
              <!-- end card cover -->
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                <div class="card__content">
                  ...
                  <ul class="card__meta">
                    ...
                    <li><span>Running time:</span> 114 min</li>
                    <li><span>Country:</span> <a href="#">USA</a> </li>
                  </ul>
                  
                  <div class="card__description card__description--details">
                     <table><?php foreach ($mahasiswa as $mhw)
  {
    if($mhw->id==1)
    {
      ...
      foreach ($time as $key) 
      {
        if($key->id<=3)
        {
          ?><form action="seat" method="post">
            ...
            <?php echo "&nbsp&nbsp&nbsp<tr><input type='submit' value='$key->time'></tr>";
                  echo "</form>";
        }
      }
    }
  ...
  ?></table>
        ...
        <!-- player -->
        <div class="col-12 col-xl-6">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/azvR__GRQic" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </video>
        </div>
        <!-- end player -->
  ...
  <!-- end details -->
   ...
   <section class="section details">
    <!-- details background -->
    <div class="details__bg" data-bg="<?php echo base_url();?>assets/img/home/home__bg2.jpg"></div>
    <!-- end details background -->
    ...
    <div class="container">
      <div class="row">
        <!-- title -->
        <div class="col-12">
          <h1 class="details__title">Men in Black: International</h1>
        </div>
        <!-- end title -->
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                <div class="card__content">
                 ...
                 <ul class="card__meta">
                    <li><span>Genre:</span>  Action, Adventure,comedy, Sci-Fi</li>
                    <li><span>Release year:</span> 2019</li>
                    <li><span>Running time:</span> 114 min</li>
                    <li><span>Country:</span> <a href="#">USA</a> </li>
                  </ul>
  ...
  ?></table>
        ...
        <!-- player -->
        <div class="col-12 col-xl-6">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/F3lJwV7ZIIk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </video>
        </div>
        <!-- end player -->
  ...
  <!-- end details -->
   ...
   <section class="section details">
    <!-- details background -->
    <div class="details__bg" data-bg="<?php echo base_url();?>assets/img/home/home__bg3.jpg"></div>
    <!-- end details background -->
